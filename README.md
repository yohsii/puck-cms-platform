...
- strongly typed design - [data querying](https://github.com/yohsii/puck-core/wiki/Querying-for-content) is done making use of query expressions and a fluent api. templates are also strongly typed.
