...
- supports sql server, sqlite, [mysql](https://github.com/yohsii/puck-core/wiki/Using-Postgresql-or-Mysql) (with pomelo ef core provider), [postgresql](https://github.com/yohsii/puck-core/wiki/Using-Postgresql-or-Mysql)
