...
- customizable and flexible [workflow system](https://github.com/yohsii/puck-core/wiki/Setting-up-custom-workflows) allowing you to keep track of what needs to be done next
